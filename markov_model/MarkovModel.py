...
def train_markov_model():
    ...
    global training_data_file, training_lines, training_words, training_time
...
def generate():
    ...
    global number_of_sentences, generated_words, generation_time

    print('Generating sample text. Number of Sentences = ', number_of_sentences)
    print('---------------------------------')
...
if __name__=='__main__':
    ...
    generate()
    print('\nSummary:')
    print('Training Data Size: ', training_lines, ' lines, ', training_words, ' words')
    print('Training Time: ', round(training_time * 1000, 6), ' ms')
    print('Text Generation Data Size: ', number_of_sentences, ' lines, ', generated_words, ' words')
